...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold text-base-content mb-4">Form Register Surat Perintah Penyitaan (B7)</h1>
    ...
    <form action="proses_register.php" method="POST">
        <div class="bg-base-100 rounded-xl shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    <label class="label font-medium">Nama/Alamat Penyita</label>
                    <textarea name="penyita" class="textarea textarea-bordered w-full" rows="2" required></textarea>
                </div>
            </div>

            <div class="mb-4">
                <label class="label font-medium">Tempat Melaksanakan</label>
                <input type="text" name="tempat" class="input input-bordered w-full" required>
            </div>

            <div class="mb-4">
                <label class="label font-medium">Nomor & Tanggal Surat Perintah</label>
                <input type="text" name="nomor_tanggal_surat" class="input input-bordered w-full" required>
            </div>

            <div class="mb-4">
                <label class="label font-medium">Nomor Laporan Polisi</label>
                <input type="text" name="nomor_lp" class="input input-bordered w-full">
            </div>

            <div class="mb-4">
                <label class="label font-medium">Nomor Surat Perintah Penyitaan</label>
                <input type="text" name="nomor_surat_penyitaan" class="input input-bordered w-full">
            </div>
